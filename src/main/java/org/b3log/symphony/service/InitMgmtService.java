...
public class InitMgmtService {
    ...
    public void initSym() {
        ...
        try {
            ...
            admin.put(User.USER_EMAIL, "tarimbbs@tarim.pub");
            ...
            tag.put(Tag.TAG_URI, "tarim");
            tag.put(Tag.TAG_ICON_PATH, "tarim.png");
            tag.put(Tag.TAG_DESCRIPTION, "[塔里木大学](http://baike.baidu.com/item/%E5%A1%94%E9%87%8C%E6%9C%A8%E5%A4%A7%E5%AD%A6) 西域学府。");
            tagMgmtService.updateTag(tagId, tag);

            tagTitle = "塔大论坛";
            tagId = tagMgmtService.addTag(adminId, tagTitle);
            tag = tagRepository.get(tagId);
            tag.put(Tag.TAG_URI, "tarimbbs");
            tag.put(Tag.TAG_ICON_PATH, "tarimbbs.png");
            tag.put(Tag.TAG_DESCRIPTION, "[tarimbbs](http://tarim.pub) 是塔里木大学唯一的论坛，是塔大师生自由分享学习的论坛。");
            tagMgmtService.updateTag(tagId, tag);

            // Hello World!
            final JSONObject article = new JSONObject();
            article.put(Article.ARTICLE_TITLE, "欢迎来到塔大论坛 &hearts;");
            article.put(Article.ARTICLE_TAGS, "tarim，塔大论坛");
