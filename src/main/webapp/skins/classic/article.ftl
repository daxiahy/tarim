...
<html>
    <head>
        ...
        <meta property="og:site_name" content="tarimbbs" />
        <!-- Twitter Card -->
                                    ...
                                    <div class="fn-flex-1">
                                        <div class="fn-clear comment-info ft-smaller">
                                            <span class="fn-left">
                                                ...
                                                <a rel="nofollow" class="ft-green" href="http://tarim.pub/tag/api">API</a>
                                                </#if>
            ...
            <#if ADLabel!="">
                <div class="module">
                    <div class="module-header">
                        <h2>
                        ${sponsorLabel}
                            <a href="http://tarim.pub/article/1494856870378" class="fn-right ft-13 ft-gray" target="_blank">${wantPutOnLabel}</a>
                        </h2>
                    </div>
