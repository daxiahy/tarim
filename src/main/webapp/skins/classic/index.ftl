            ...
            <div class="index__bottom">
                <div class="wrapper">
                    ...
                    <div class="metro-line fn-flex">
                        <div class="metro-item">
                            <!-- ${ADLabel} -->
                            <a class="preview" href="http://tarim.pub/domain/news">
                                <img width="44px" src="${staticServePath}/images/tags/news.png" alt="${sponsorLabel}">
                                <b>Manual</b>
                            </a>
                        </div>
                        <div class="metro-item last">
                            <a class="preview" href="http://tarim.pub/article/1494856870378">
